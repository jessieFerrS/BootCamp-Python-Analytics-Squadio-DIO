...
def prever_afinidade_elemental(intensidade, componente_raro, fase_lunar, idade_feiticeiro, afinidade_animais):
    ...
    elif intensidade >= 7 and componente_raro_feitico == "sim" and idade_feiticeiro <= 100 and fase_lunar_feitico == "cheia":
        if afinidade_animais_feiticeiro == "sim":
...
# Fazendo a previsão
resultado = prever_afinidade_elemental(intensidade_feitico, componente_raro_feitico, fase_lunar_feitico,
                                       idade_feiticeiro, afinidade_animais_feiticeiro)
